<script lang="ts" module>
	...
	export const sheetVariants = tv({
		base: 'glass-medium bubble-shadow-lg data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col gap-4 transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500',
		variants: {
			side: {
